...
import { createClientKeySchema, listClientKeysQuerySchema } from "../modules/api-key/api-key.schema";
...
router.delete("/delete/:id", authenticate, authorize(UserRole.ADMIN), deleteClientKey);
